...
export default function FactureFormTemplate({
    ...
    //                 <Text style={styles.tableCell}>{item.pivot.quantite}</Text>
    //             </View>
    //             <View style={styles.tableCol}>
    ...
    //             <View style={styles.tableCol}>
    //                 <Text style={styles.tableCell}>
    //                     {item.pivot.remise ? item.pivot.remise : "-"}
    //                 </Text>
    //             </View>
    //             <View style={styles.tableCol}>
    //                 <Text style={styles.tableCell}>
    //                     {parseFloat(
    //                         (item.prix -
    //                             (item.prix * item.pivot.remise) / 100) *
    //                             item.pivot.quantite
    //                     ).toFixed(3)}
    //                 </Text>
    //             </View>
        ...
        <Document>
            <Page size="A4" width={900} style={styles.page} wrap>
                ...
                >
                    ...
                    >
                        {type !== 'caisse' && <Text style={{ fontSize: 10 }}>
